...
// Helper: renderiza el ícono de una rutina (usa r.Ic o resuelve por iconId)
...
// Backwards-compat: HomeInactive default
...
{ id: 'cold30', title: 'Ducha fría · 30 días', tagline: 'Disciplina antes que motivación', day: 30, total: 30, accent: '#6ab8ff', Ic: IcWind, status: 'completed',
  ...
  desc: 'Treinta días de duchas frías. Entrenar la mente para hacer lo difícil cuando es difícil. Tu yo del futuro te lo agradecerá.',
...
{ id: 'l1', title: 'Hábitos Atómicos', author: 'James Clear', kind: 'Resumen', dur: '18 min',
  ...
  narrator: 'Voz · Mentex AI', rating: 4.9, plays: '124k', status: 'scheduled',
  desc: 'Cómo cambios pequeños y consistentes producen resultados extraordinarios. La ciencia de los hábitos, destilada.',
  chapters: [
  { t: 'La sorpresa del 1%', d: '3:12' },
  { t: 'Sistemas vs metas', d: '4:48' },
  { t: 'Las 4 leyes del cambio', d: '6:24' },
  { t: 'Identidad antes que resultado', d: '3:36' }]
},
{ id: 'l2', title: 'Respira y vuelve a ti', author: 'Mentex', kind: 'Meditación', dur: '12 min',
  ...
  chapters: [
  { t: 'Anclaje en el cuerpo', d: '3:00' },
  { t: 'Respiración 4-7-8', d: '4:30' },
  { t: 'Escaneo corporal', d: '3:30' },
  { t: 'Cierre y agradecimiento', d: '1:00' }]
},
{ id: 'l3', title: 'La historia de Apple', author: 'Steve Jobs', kind: 'Biografía', dur: '22 min',
  ...
  chapters: [
  { t: 'El garaje y los inicios', d: '5:00' },
  { t: 'La salida y la travesía', d: '6:00' },
  { t: 'El regreso y el iPod', d: '5:30' },
  { t: 'iPhone y legado', d: '5:30' }]
},
{ id: 'l4', title: 'Sapiens', author: 'Yuval Harari', kind: 'Resumen', dur: '25 min',
  ...
  narrator: 'Voz · Mentex AI', rating: 4.7, plays: '156k', status: 'new',
  desc: 'La historia de cómo una especie irrelevante de monos terminó dominando el planeta. Una mirada en perspectiva.',
  chapters: [
  { t: 'La revolución cognitiva', d: '6:00' },
  { t: 'La revolución agrícola', d: '6:30' },
  { t: 'La unificación de la humanidad', d: '6:30' },
  { t: 'La revolución científica', d: '6:00' }]
},
{ id: 'l5', title: 'El poder del ahora', author: 'Eckhart Tolle', kind: 'Resumen', dur: '20 min',
  ...
  chapters: [
  { t: 'No eres tu mente', d: '5:00' },
  { t: 'El cuerpo del dolor', d: '5:30' },
  { t: 'Entrar en el ahora', d: '5:00' },
  { t: 'El portal hacia el ser', d: '4:30' }]
},
{ id: 'l6', title: 'Deep Work', author: 'Cal Newport', kind: 'Resumen', dur: '19 min',
  ...
  narrator: 'Voz · Daniel', rating: 4.9, plays: '178k', status: 'new',
  desc: 'En un mundo de distracciones infinitas, la capacidad de hacer trabajo profundo es la habilidad más rara y valiosa.',
  chapters: [
  { t: 'El valor del enfoque', d: '4:30' },
  { t: 'Reglas para la profundidad', d: '5:30' },
  { t: 'Eliminar lo superficial', d: '4:30' },
  { t: 'Drenar lo poco profundo', d: '4:30' }]
},
{ id: 'l7', title: 'Lluvia profunda', author: 'Mentex Sound', kind: 'Sonido', dur: '60 min',
  ...
  chapters: [
  { t: 'Apertura suave', d: '12:00' },
  { t: 'Lluvia constante', d: '24:00' },
  { t: 'Picos de intensidad', d: '14:00' },
  { t: 'Cierre y silencio', d: '10:00' }]
},
{ id: 'l8', title: 'Cómo construir un MVP', author: 'Y Combinator', kind: 'Curso', dur: '38 min',
  ...
  narrator: 'Voz · Michael Seibel', rating: 4.8, plays: '156k', status: 'new',
  desc: 'El framework definitivo para validar una idea sin morir intentándolo. Lecciones de cientos de fundadores.',
  chapters: [
  { t: 'Qué es y qué no es un MVP', d: '8:00' },
  { t: 'Construir con velocidad', d: '10:00' },
  { t: 'Hablar con usuarios', d: '12:00' },
  { t: 'Decidir qué cortar', d: '8:00' }]
},
{ id: 'l9', title: 'Dieter Rams · Menos pero mejor', author: 'Diseño industrial', kind: 'Biografía', dur: '24 min',
  ...
  chapters: [
  { t: 'Los 10 principios', d: '8:00' },
  { t: 'La era Braun', d: '6:30' },
  { t: 'Su influencia en Apple', d: '5:30' },
  { t: 'Legado', d: '4:00' }]
},
{ id: 'l10', title: 'Steve Jobs · Stanford 2005', author: 'Charla legendaria', kind: 'Charla', dur: '15 min',
  ...
  chapters: [
  { t: 'Conectando los puntos', d: '5:00' },
  { t: 'Amor y pérdida', d: '5:00' },
  { t: 'Sobre la muerte', d: '5:00' }]
},
{ id: 'l11', title: 'Bosque al amanecer', author: 'Mentex Sound', kind: 'Sonido', dur: '45 min',
  ...
  chapters: [
  { t: 'Antes del alba', d: '12:00' },
  { t: 'Primer canto', d: '15:00' },
  { t: 'Coro completo', d: '18:00' }]
}];
...
function HomeInactive({ tweaks, state, setState, onStart, onCustom, challenges = CHALLENGES, learning = LEARNING, routinesCatalog = ROUTINES, onChallengeClick = () => {}, onViewAllChallenges = () => {}, onNotif = () => {}, notifCount = 0, _placeholder = () => {}, onLearningClick = () => {}, onViewAllLearning = () => {}, onEditApps = () => {}, onEditRoutines = () => {} }) {
  ...
  const toggleApp = (id) => setState((s) => ({
    ...s,
    blockedApps: s.blockedApps.includes(id) ?
    s.blockedApps.filter((x) => x !== id) :
    [...s.blockedApps, id]
  }));
  const toggleRoutine = (id) => setState((s) => ({
    ...s,
    routines: s.routines.includes(id) ? s.routines.filter((x) => x !== id) : [...s.routines, id]
  }));
  ...
  const glassFor = (extra = {}) => {
    if (cardStyle === 'flat') return {
      background: 'rgba(255,255,255,0.025)', border: '0.5px solid rgba(255,255,255,0.04)',
      backdropFilter: 'none', ...extra
    };
    if (cardStyle === 'thin') return {
      background: 'transparent', border: '0.5px solid var(--glass-stroke-strong)',
      backdropFilter: 'none', ...extra
    };
    return extra;
  };
    ...
    <div style={{
      ...
      <div style={{ marginBottom: 28, marginTop: 4 }}>
        <div className="mtx-scroll-x" style={{ paddingLeft: 20, paddingRight: 20 }}>
          <MtxStatCard label="Tiempo enfocado" value="14" unit="h 32m" sub="+18% vs semana anterior" accent
          sparkData={[2, 3, 4, 3, 5, 6, 7]} />
          <MtxStatCard label="Sesiones" value="22" sub="completadas esta semana"
          sparkData={[3, 2, 4, 3, 5, 3, 4]} />
          <MtxStatCard label="Apps bloqueadas" value="6" sub="distractores neutralizados"
          sparkData={[4, 5, 6, 5, 6, 6, 7]} />
          <MtxStatCard label="Días con enfoque" value="6" unit="/7" sub="racha activa 🔥"
          sparkData={[1, 1, 1, 1, 0, 1, 1]} />
          <MtxStatCard label="Aprendido" value="11" sub="contenidos completados"
          sparkData={[1, 2, 1, 2, 2, 1, 2]} />
        </div>
      </div>

      {/* ── Apps a bloquear ─────────────────────────────── */}
      <div style={{ marginBottom: 28 }}>
        <MtxSectionHead title="Apps a bloquear" subtitle="Silencia el ruido. Recupera tu atención." action="Editar" onAction={onEditApps} />
        <div className="mtx-glass" style={{
          margin: '0 20px', padding: 6, borderRadius: 22,
          ...glassFor()
        }}>
          ...
          {APPS.filter(a => state.blockedApps.includes(a.id)).length === 0 && (
            <div style={{
              ...
              No hay apps silenciadas todavía
            </div>
          )}
          <div onClick={onEditApps} className="mtx-tap" style={{
            ...
            <IcPlus size={16} stroke="currentColor" /> Agregar otras apps
          </div>
        </div>
      </div>
          ...
          {routinesCatalog.map((r) => {
            ...
            return (
              <button key={r.id} onClick={() => toggleRoutine(r.id)} className="mtx-glass mtx-tap" style={{
                ...
                background: on ?
                'linear-gradient(180deg, rgba(61,255,209,0.10), rgba(61,255,209,0.02))' :
                'var(--glass-2)',
                boxShadow: on ?
                '0 0 0 1px rgba(61,255,209,0.15), 0 10px 30px -10px rgba(61,255,209,0.45), inset 0 0 24px rgba(61,255,209,0.10)' :
                'var(--shadow-card)',
                textAlign: 'left',
      ...
      {/* ── Desafíos ────────────────────────────────────── */}
      <div style={{ marginBottom: 28 }}>
        <MtxSectionHead title="Desafíos" subtitle="Compromisos que transforman semanas." action="Ver todo"
        onAction={onViewAllChallenges} />
        <div className="mtx-scroll-x" style={{ paddingLeft: 20, paddingRight: 20 }}>
          {challenges.map((c) =>
      ...
      {/* ── Aprendizaje del día ─────────────────────────── */}
      <div style={{ marginBottom: 28 }}>
        <MtxSectionHead title="Elige tu aprendizaje" subtitle="Ideas que valen tu tiempo." action="Ver más"
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div className="mtx-scroll-x" style={{ paddingLeft: 20, paddingRight: 20, fontSize: "15px", gap: "9px", justifyContent: "flex-start", height: "45px", width: "360px" }}>
          {TIME_OPTIONS.map((t) => {
            const isActive = time === t.v;
            const isCustom = t.v === -1;
            return (
              <button key={t.v} onClick={() => setTime(t.v)} className={(isActive ? 'mtx-pill-active ' : '') + 'mtx-tap'} style={{
                ...
                border: isActive ?
                '0.5px solid rgba(61,255,209,0.55)' :
                ...
                boxShadow: isActive ?
                '0 0 0 1px rgba(61,255,209,0.18), 0 8px 28px -8px rgba(61,255,209,0.55), inset 0 0 24px rgba(61,255,209,0.14)' :
                'none',
                transform: isActive ? 'translateY(-1px)' : 'translateY(0)',
                transition: 'transform .25s cubic-bezier(.34,1.56,.64,1), box-shadow .3s ease, background .25s ease, border-color .25s ease',
                fontFamily: 'var(--ff-sans)', width: "90px"
              }}>
                {isCustom && <IcEdit size={14} stroke="currentColor" />}
                {t.label}
              </button>);
